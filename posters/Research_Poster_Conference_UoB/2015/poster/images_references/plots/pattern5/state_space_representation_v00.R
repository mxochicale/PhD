...
filenameimage <- paste("ssr_ep5",".png",sep="") 
...
filenameimage <- paste("ssr_ip5",".png",sep="") 
png(filenameimage, width=2600, height=2600, units="px", res=200,bg = "transparent")
...
filenameimage <- paste("ssr_np5",".png",sep="") 
png(filenameimage, width=2600, height=2600, units="px", res=200,bg = "transparent")
xyplot(pcamatrix_nmz[[3]][1,] ~ pcamatrix_nmz[[3]][2,],
       ...
       grid = FALSE,
       #scales=list(font=1, cex=3, y=list(at=seq(-8,8,2),limits=c(-7.5,7.5)),x=list(at=seq(-4,4,2),limits=c(-5.5,5.5)) ),
       scales=list(font=1, cex=3, y=list(at=seq(-6,6,2),limits=c(-7,7)),x=list(at=seq(-5,5,2),limits=c(-5,5)) ),
       abline=list(h=0,v = 0,lwd=4,lty=2),
       trellis.par.set("axis.line",list(col="black",lty=1,lwd=4))
)
dev.off()
