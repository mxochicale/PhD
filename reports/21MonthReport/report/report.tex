...
\usepackage{eurosym} % Use of euro symbols
...
\author{
% Miguel Xochicale
 	Miguel~P.~Xochicale,~\IEEEmembership{Doctoral~Researcher;}\\
         Chris~Baber,~\IEEEmembership{Lead~Supervisor;}
         ~Martin~Russell,~\IEEEmembership{Co~Supervisor;} \\
         and~Neil~Cooke,~\IEEEmembership{Academic~Advisor.}
         % <-this % stops a space

 \IEEEcompsocitemizethanks{\IEEEcompsocthanksitem
 M. P. Xochicale, C. Baber, M. Russell and N. Cooke are with the School of Engineering,
 The University of Birmingham, UK. \protect\\
...
Data were collected on hand orientation using a Microsoft Kinect sensor \cite{Lim2012}. % as reference coordinates.
Lim \textit{et al.}
...
%  with the statistical significant variability
% However,
% Lim \textit{et al.} stated that
% ``the gesture type did not show significant effect of the variation``
