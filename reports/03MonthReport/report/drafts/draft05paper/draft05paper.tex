...
% While this might limit the detail that you would get from the analysis
% it might provide a different level of detail on the differences between sources 
% of the data.
...
%   \item Which axes among accelerometer, gyroscope and magnetometer 
